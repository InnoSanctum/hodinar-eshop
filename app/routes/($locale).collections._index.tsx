    ...
    <div>
      <div className=" lg:sticky lg:top-20">
        <div className="filter__height overflow-y-scroll">
          ...
          <div className="p-4 border-t-2 border-secondary flex flex-wrap gap-4 lg:flex-col">
            <h4>{language.filters.style}</h4>
          ...
          <div className="p-4 border-t-2 border-secondary flex flex-wrap gap-4 lg:flex-col">
            <h4>
              {language.filters.price} ({products[0].priceRange.minVariantPrice.currencyCode})
            </h4>
            <input
              name="q"
          ...
          <div className="p-4 border-t-2 border-secondary flex flex-wrap gap-4 lg:flex-col">
            <h4>{language.filters.clockwork}</h4>
